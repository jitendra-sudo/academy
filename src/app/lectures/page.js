        ...
        <div className="container mx-auto px-4 py-10">
          ...
          <div className="mt-16 bg-gradient-to-br from-[#0f172a] to-[#1e3a8a] rounded-3xl p-8 text-center text-white">
            ...
            <div className="flex flex-wrap gap-3 justify-center">
              ...
              <a href="https://wa.me/919003190030" target="_blank" rel="noreferrer" className="bg-green-500 hover:bg-green-400 text-white font-bold px-6 py-3 rounded-xl transition-all flex items-center gap-2">
